Change Log (2025-11-10):
– Added a rule to prioritize <25 min walking distance when user preference is “short walks only”.
...
3. **Too Far or Long Travel**
   ...
   - **IF user_preference includes "short walks only":**
    THEN all selected activities must be within <25 minutes walking distance
    OR automatically replace far activities with closer alternatives.
